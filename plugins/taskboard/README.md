...
<p align="center">
  <a href="https://github.com/lettland/bb-plugins/actions/workflows/test.yml"><img src="https://img.shields.io/github/actions/workflow/status/lettland/bb-plugins/test.yml?branch=master&style=flat-square&label=CI" alt="CI status" /></a>
...
```sh
bb plugin install git:https://github.com/lettland/bb-plugins.git@^0.3.3 --subdirectory plugins/taskboard --tag-prefix taskboard/
```
