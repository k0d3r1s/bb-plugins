...
Shared procedure for `/devkit:review-code`, `/devkit:review-impl`, `/devkit:review`, and
`/devkit:security-audit`. It decides which changed files are **auto-generated artifacts**
