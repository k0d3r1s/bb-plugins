...
Borrowed from stop-slop but **deliberately rejected** for devkit — do not "complete the import" by adding these:

- **Em-dash ban** — devkit uses em dashes throughout its docs and skills. Keep them.
