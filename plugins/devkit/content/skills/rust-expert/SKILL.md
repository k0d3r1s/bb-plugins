---
name: rust-expert
description: Expert bundle — Use when working in Rust — essentials (ownership, errors, cargo, traits), async (Tokio), axum/actix, testing.
---
...
Load these with `devkit_load_skill`: orm-overview, postgres, rust-async-tokio, rust-axum-actix, rust-essentials, rust-testing, testing-property-based.
