---
name: cmd-onboard
description: Command — Onboard to a new codebase - architecture scan, key decisions, first tasks. Works on a local directory only; clone the repo first if you have a URL.
---
...
Then re-run: /devkit:onboard ~/workspace/<name>
```
