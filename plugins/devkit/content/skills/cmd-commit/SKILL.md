---
name: cmd-commit
description: Command — Create git commits for all uncommitted changes and land them on the project's mainline, matching the repo's existing commit style
---
